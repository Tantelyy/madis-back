...
describe('calculateGiftProductPromotionAllocation', () => {
  it('limits bundles to the stock of the purchased and offered products', () => {
    const allocation = calculateGiftProductPromotionAllocation(8, 8, 2, 2, 1);
